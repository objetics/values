...
public class InformationTest {
    ...
    public static void main(String[] args) {
        ...
        s = "abcdefghijklmnop";
        System.out.println(s + " (Shannon): " + SFSMInfo.information(s));
        ...
        for(String str : array){
            sInfo += SFSMInfo.information(str);
        ...
        System.out.println(str + " (Shannon): " + SFSMInfo.information(str));
...
"dispersion principle.";
        System.out.println("Log English text" + " (Shannon): " + SFSMInfo.information(s));
